...
**4.** Turn on the board switch. An LED should be on on the other side of the switch. Plug in the flight controller board with a USB-C cable, and flip on the switch. The flight controller board has an LED that turns on.
