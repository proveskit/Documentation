...
So enter the original premise of the Pleiades Rapid Orbital Verification Experiment System (PROVES) Kit! The idea here was to try and remove as much complexity from the satellite as possible in order to make it as straightforward and easy to work with as can be. We needed to set some kind of measurable benchmark for whether or not we achieved this goal, so we decided to go for two things: 
